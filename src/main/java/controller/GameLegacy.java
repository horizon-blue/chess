...
public class GameLegacy {
    ...
    /**
     * Equivalent to GameLegacy(whitePlayer, blackPlayer, 8, 8);
     *
     * @param whitePlayer player with white pieces
     * @param blackPlayer player with black pieces
     */
    public GameLegacy(Player whitePlayer, Player blackPlayer) {
     ...
     */
    public GameLegacy(Player whitePlayer, Player blackPlayer, int boardHeight, int boardWidth) {
